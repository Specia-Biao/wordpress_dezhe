...
$parent_id = get_category( $catId )->parent;
?>
...
<div class="insideBanner por" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/static/upload/store_banner.png);">
    ...
    <div class="path wp1200 clearfloat">
        ...
        <div class="bread">
            <a href="/">首页</a> >&nbsp;
            <a href="<?php the_permalink( 304 ); ?>"><?php echo get_category( get_category( $parent_id )->parent )->cat_name; ?></a> >&nbsp;
            <a href="<?php the_permalink( 304 ); ?>"><?php echo get_category( $parent_id )->cat_name; ?></a>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/static/js/zt/city.js"></script>
